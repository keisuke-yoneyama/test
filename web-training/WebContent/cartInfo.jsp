	...
	<div id="main" class="clear">
		...
		<div class="marginLeft">
			...
			<table border="1" class="ShowData">
				...
				<tr>
					<th><input type="checkbox" name="checkList" value='<s:property value="id" />'></th>
				...
				<h2>カート合計金額：<s:property value="total_price" /></h2>
				<a href='<s:url action="SettlementConfirmAction" />'>
					<input type="button" value="決済" class="button">
				</a>
